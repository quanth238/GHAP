...
run_scene() {
  ...
  CUDA_VISIBLE_DEVICES="$CUDA_DEVICE" python train_and_prune.py \
    ...
    --disable_viewer \
    --iterations 30000 \
    --test_iterations 15002 30000 \
    --save_iterations 15002 30000 \
    --checkpoint_iterations 30000 \
    --sampling_iter 15001 \
    "${COMMON_COMPACT_ARGS[@]}"

  # 4) Compact render + metrics
  CUDA_VISIBLE_DEVICES="$CUDA_DEVICE" python render.py --iteration 30000 -s "$src" -m "$compact_out" --eval --skip_train
