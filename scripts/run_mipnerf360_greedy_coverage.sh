...
# Batch Greedy Coverage sweep for MipNeRF360.
# Runs retention ratios and logs metrics, similar to RSS scripts.

CUDA_DEVICE="${CUDA_DEVICE:-3}"
RUN_BASELINE="${RUN_BASELINE:-no}" # "yes" to train baseline checkpoints
OUT_DIR="${OUT_DIR:-./experiments}"
EXP_TITLE="${EXP_TITLE:-mipnerf360_greedy_coverage}"
RUNS="${RUNS:-1}"
...
SWEEP_SUMMARY="${RESULT_DIR}/mipnerf360_greedy_coverage_summary.csv"
